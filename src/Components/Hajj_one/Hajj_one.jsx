  ...
  return (
    <div >
      ...
      <Typography className='text-white py-3' variant="h6" style={{ background: "#02A3C1" }} sx={{ flexGrow: 1 }}>
        <div className='text-center pt-1'><h2> Hajj Packages</h2><p className='fs-6 pb-3'>Budget-Friendly & Luxury Package for a  convenient hajj & umrah journey to the holly <br />
