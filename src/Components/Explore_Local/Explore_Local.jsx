...
import Monuments from '../Explore_Monuments/Monuments/Monuments'

function Explore_Local() {
  return (
    <div className='' >
      <Cities_Places/>

       <Monuments title="Al - Hukair Land Monument Park"
