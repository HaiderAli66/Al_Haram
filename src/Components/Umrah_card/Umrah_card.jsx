  ...
  return (
    ...
    <div class="card hxn_card shadow mb-4">
      <div class="  row g-0">
        <div class="col-lg-4">
           <div className=''>
          <img src="depositphotos_311884494-stock-photo-masjid-al-haram-muslims-holiest 2.png" class="img-fluid rounded-start max-height  w-100" alt="..."/>
          </div>
    </div>
        <div class="col-lg-8">
     ...
     <h4 className=' float-end clr_bl'><CurrencyRupeeIcon />120,000 </h4></div>
         ...
         <Link to='/Umra_main'><button className='btn btn-sm ucard btn-000  my-2 text-white btn_hvr1 '>VIEW DETAIL</button></Link>
    ...
    <div className="col col-sm-12 col-md-4 mt-3 justify-content-end d-flex">
    
    <Link to='/Umra_main'><button className='btn  ucard text-white btn_hvr1'>40 Remaining Pax </button></Link>
