...
<input type="date" placeholder='how u doing' className='p-3 mb-2 w-100  rounded border' />
</div>
...
<div className=' '>
 ...
 <div className="p-3"> <button className='btn btn-outline-light p-3 w-100 mb-2 uHover text-white'><b>Make an Esnquiry</b></button><br/>
 <Link to="/Main_booking"> <button className='btn btn-outline-light p-3 mb-2  w-100 uHover text-white' ><b>Book Now</b></button></Link></div>
