    ...
    <AppBar position="static" sx={{ background: "#02A3C1" }}>
      ...
      <Typography className='text-white py-3' variant="h6" style={{ background: "#02A3C1" }} sx={{ flexGrow: 1 }}>
        ...
        <div className="container-fluid mt-5 p-0">
            ...
            <div className='pb-3'>
                <h2>TYPES OF PROPERTIES CAN BE LISTED ON AL HARAM</h2>
                <p className='text-muted px-3 '>Come Aboard India's No. 1 Travel Company & Unfold Infinite Possibilities Of Growth.</p>
            </div>
            <div className='mt-4 d-flex justify-content-end me-5 ay_pro'><button type="button" class="btn btn-lg text-white ayp">ADD YOUR PROPERTY</button></div>
            </div>
      ...
      >
        <SwiperSlide className='silde'>
          <div>
            <img src="./images/Propertie_images/hotel_1.png" alt="" />
            <figcaption className="text-white tol pt-2 pb-2">HOTELS</figcaption>
            </div>
        </SwiperSlide>
        <SwiperSlide className='silde'>
          <div>
            <img src="./images/Propertie_images/hotel_2.png" alt="" />
            <figcaption className="text-white tol pt-2 pb-2">VILLAS</figcaption>
            </div>
            </SwiperSlide>
        <SwiperSlide className='silde'>
          <div>
            <img src="./images/Propertie_images/hotel_3.png" alt="" />

       
              <p  className="text-white tol pt-2 pb-2">APRTMENTS</p>
    </div>
        ...
        <SwiperSlide className='silde'>
          <div>
            ...
            <p  className="text-white tol pt-2 pb-2">HOTELS</p>
            </div>
            </SwiperSlide>
        <SwiperSlide className='silde'>
          <div>
        ...
        <SwiperSlide className='silde'>
          <div>
            <img src="./images/Propertie_images/hotel_3.png" alt="" />
            <figcaption className="text-white tol pt-2 pb-2">APRTMENTS</figcaption>
            </div>
            </SwiperSlide>
      </Swiper>
        </div>
        ...
        <div className="container-fluid happy_host">
            <div className=''>
                ...
                <p className='text-muted pb-5'>Come Aboard India's No. 1 Travel Company & Unfold Infinite Possibilities Of Growth.</p>
            </div>
      ...
      >
        <SwiperSlide>
          <div className="comments pt-5 pb-5 px-3">
            <div>
                <div className="">
